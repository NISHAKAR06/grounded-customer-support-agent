...
- **No Post-Hoc Contamination**: As recorded in [`docs/DECISION_LOG.md`](DECISION_LOG.md), we strictly refrained from tuning thresholds or prompt rubrics post-hoc to artificially improve agreement scores.
...
As documented in [`docs/FAILURE_ANALYSIS.md`](FAILURE_ANALYSIS.md):
